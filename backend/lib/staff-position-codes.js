...
function inferPositionCode(input = {}) {
  ...
  const aliasMap = new Map([
    ...
    ["i-t-assistant", "it-assistant"],
    ["manager-it", "manager-it"],
    ["manager-i-t", "manager-it"],
    ["it-manager", "it-manager"],
    ["i-t-manager", "it-manager"],
    ["academic-officer-head", "academic-officer-head"],
    ["head-academic-officer", "academic-officer-head"],
    ["assistant-accountant", "assistant-accountant"],
    ["assistant-account-clerk", "assistant-account-clerk"],
    ["shop-keeper", "shop-keeper"],
    ["shopkeeper", "shop-keeper"],
    ["maintenance-manager", "maintenance-manager"],
    ["primary-secretary", "primary-secretary"],
    ["assistant-primary-secretary", "assistant-primary-secretary"],
