...
('master_edutrack_admin', 'eduzync', 1, 1, 1, 1),
('master_edutrack_admin', 'edutrack', 1, 1, 1, 1),
('master_edutrack_admin', 'report_cards', 1, 1, 1, 0),
...
CREATE TABLE IF NOT EXISTS edutrack_daily_syllabus_progress (
  ...
  KEY idx_daily_syllabus_teacher_id (teacher_id),
  KEY idx_daily_syllabus_record_date (record_date),
  KEY idx_daily_syllabus_subject (subject),
  KEY idx_daily_syllabus_grade (grade),
  KEY idx_daily_syllabus_section (section),
  KEY idx_daily_syllabus_unit_number (unit_number)
);
