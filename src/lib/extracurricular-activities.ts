...
export const EXTRA_CURRICULAR_GROUPS: ExtraCurricularActivityGroup[] = [
  {
    ...
    description: "Literary, debate, media, charity, and student society activities across sections.",
  },
  {
  ...
  },
  {
    ...
    description: "House leadership, specialist coaches, and technical trainers named in the source document.",
  },
];
...
export const EXTRA_CURRICULAR_ACTIVITIES: ExtraCurricularActivity[] = [
  ...
  },
  {
    ...
    teachers: [
      "Mrs. Deshani Marasinghe",
      "Mrs. Darshini Suraweera",
      "Mr. Amantha Fernando",
    ],
  },
  {
