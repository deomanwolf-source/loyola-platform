...
const rolePermissionRows: { role: Role; access: string; scope: string }[] = [
  ...
  { role: "eduzync_admin", access: "School data", scope: "Students, classes, teachers, EduTrack" },
  {
    ...
    access: "Coordination",
    scope: "EduTrack teaching, year plan reviews, analytics",
  },
...
function StaffPanel({ db }: { db: DB }) {
  ...
  const autoPlacementMap: Record<string, string> = {
    ...
    "Assistant Sectional Head - Primary School": "Assistant Sectional Heads",
    "Assistant Sectional Head - Middle School": "Assistant Sectional Heads",
    "Assistant Sectional Head - Upper School": "Assistant Sectional Heads",
    "Assistant Sectional Head - Advanced Level": "Assistant Sectional Heads",
